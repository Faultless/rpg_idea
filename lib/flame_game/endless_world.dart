...
class EndlessWorld extends World with TapCallbacks, HasGameReference {
  ...
  Future<void> onLoad() async {
    ...
    scoreNotifier.addListener(() {
      if (scoreNotifier.value % 2 == 0 && scoreNotifier.value > 0) {
        levelUp();
      }
  ...
  void levelUp() {
    playerProgress.setDexterity(playerProgress.dexterity + 1);
    playerProgress.setIntelligence(playerProgress.intelligence + 1);
